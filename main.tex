...
\begin{center}
  \begin{minipage}[b]{0.4\linewidth}
    \includegraphics{lim-right-kan-1}
  \end{minipage}
  \begin{minipage}[b]{0.4\linewidth}
    \includegraphics{lim-right-kan-2}
  \end{minipage}
\end{center}
...
\begin{center}
  \begin{minipage}[b]{0.4\linewidth}
    \includegraphics{colim-left-kan-1}
  \end{minipage}
  \begin{minipage}[b]{0.4\linewidth}
    \includegraphics{colim-left-kan-2}
  \end{minipage}
\end{center}
