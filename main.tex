...
\begin{center}
  \includegraphics{src/yoneda-embedding}
\end{center}
...
\begin{center}
  \includegraphics{src/terminal-and-initial-object}
\end{center}
...
\begin{definition}[錐の圏]
  ...
  \begin{center}
    \includegraphics{src/cone-category}
  \end{center}
\end{definition}
...
\begin{definition}[余錐の圏]
  ...
  以下の図式を可換にする自然変換 $\id{d}\to\id{d'}$ である．
  \begin{center}
    \includegraphics{src/cocone-category}
  \end{center}
\end{definition}
