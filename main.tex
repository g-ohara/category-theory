...
\begin{definition}[米田埋め込み]
  ...
  圏 $\cat{C}$ について，
  \begin{itemize}
    \item 対象 $\c\in\objs{\cat{C}}$ を函手
          $\mrp{\mrps{\cat{C}}{-}{\c}}{\op{\cat{C}}}{\set}$ に写し，
    \item 射 $f\in\mrps{\cat{C}}{\c}{\d}$ を自然変換
          $\mrp{\mrps{\cat{C}}{-}{f}}{\mrps{\cat{C}}{-}{\c}}{\mrps{\cat{C}}{-}{\d}}$
          に写す
  \end{itemize}
  函手 $\cat{C}\to\set^{\op{\cat{C}}}$
